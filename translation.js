...
document.addEventListener('DOMContentLoaded', () => {
    ...
    translations = {
     ...
     // --- swipevibe.html & Onboarding ---
            swipeDiscoverTitle: { en: 'Discover Other Gamers', th: 'ค้นพบเกมเมอร์คนอื่นๆ' },
            swipeDiscoverSubtitle: { en: 'Swipe to find your next favorite teammate.', th: 'ปัดเพื่อหาเพื่อนร่วมทีมคนโปรดคนต่อไปของคุณ' },
            swipeThatsEveryone: { en: "That's Everyone!", th: 'ดูครบทุกคนแล้ว!' },
            swipeThatsEveryoneDesc: { en: "You've seen all available gamers. Check back later for new profiles.", th: 'คุณดูโปรไฟล์เกมเมอร์ที่มีอยู่ทั้งหมดแล้ว กลับมาเช็คใหม่ภายหลังนะ' },
            cardTraits: { en: 'Traits', th: 'ลักษณะนิสัย' },
            cardPlays: { en: 'Plays', th: 'เกมที่เล่น' },
            cardRank: { en: 'Rank', th: 'อันดับ' },
            onboardingTitle: { en: 'First Time Here?', th: 'มาที่นี่ครั้งแรกหรือเปล่า?' },
            onboardingSubtitle: { en: 'Are you familiar with Swipe & Match?', th: 'คุณคุ้นเคยกับระบบปัดเพื่อจับคู่ไหม?' },
            onboardingYes: { en: "Yes, I'm Ready", th: 'ใช่, ฉันพร้อมแล้ว' },
            onboardingNo: { en: 'No, Show Me How', th: 'ไม่, สอนฉันหน่อย' },
            tutorialTitleStep1: { en: 'Step 1: Decide', th: 'ขั้นตอนที่ 1: ตัดสินใจ' },
            tutorialDescStep1: { en: 'Use the main buttons to Like (❤️), Skip (❌), or give a Priority Like (⭐) to a profile.', th: 'ใช้ปุ่มหลักเพื่อกดไลค์ (❤️), ข้าม (❌), หรือให้ Priority Like (⭐) แก่โปรไฟล์' },
            tutorialNext: { en: 'Next →', th: 'ต่อไป →' },
            tutorialTitleStep2: { en: 'Step 2: Revert', th: 'ขั้นตอนที่ 2: ย้อนกลับ' },
            tutorialDescStep2: { en: 'Made a mistake? Hit the Revert (🔄) button to get the last profile back. You can only do this once per swipe!', th: 'ทำพลาดเหรอ? กดปุ่มย้อนกลับ (🔄) เพื่อดึงโปรไฟล์ล่าสุดกลับมา คุณทำได้แค่ครั้งเดียวต่อการปัดหนึ่งครั้ง!' },
            tutorialBack: { en: '← Back', th: '← กลับ' },
            tutorialTitleStep3: { en: 'Step 3: Match!', th: 'ขั้นตอนที่ 3: จับคู่!' },
            tutorialDescStep3: { en: 'If you both Like each other, it’s a Match! A popup will appear, and you can start a conversation.', th: 'ถ้าคุณทั้งคู่กดไลค์กันและกัน มันคือการจับคู่! ป๊อปอัปจะปรากฏขึ้น และคุณสามารถเริ่มบทสนทนาได้' },
            tutorialFinish: { en: "Let's Go!", th: 'ไปกันเลย!' },
            matchPopupTitle: { en: "🎉 It's a Match!", th: '🎉 จับคู่สำเร็จ!' },
            swipeKeepSwiping: {en: "Keep Swiping", th: 'ปัดต่อไป'},
            matchPopupDesc: { en: 'You and {{name}} have liked each other!', th: 'คุณและ {{name}} ได้กดไลค์ให้กันและกัน!' },
            // You can re-use 'swipeKeepSwiping' from your existing translations
